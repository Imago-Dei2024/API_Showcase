...
# ==== API Parameters ==== #
# 1. ❚ Required: function - The function of your choice. In this case, function=BRENT
...
def brent_crude_oil():
    ...
    # Select Interval
    while True:
        print("Please Select an Interval for Brent Crude Oil Prices:")
        print("1. Daily")
        print("2. Weekly")
        print("3. Monthly")
    ...
    filename = f"Commodity_Data/brent_crude_oil_{interval}.csv"
    with open(filename, 'w') as file:
        file.write(response.text)

    print(f"Successfully Downloaded Brent Crude Oil ({interval}) Data to {filename}")
    ...
    column_mapping = {
        'date': 'Date',
        'value': 'Brent Price (USD per Barrel)'
    }
