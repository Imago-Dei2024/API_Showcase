...
# ==== API Parameters ==== #
# 1. ❚ Required: function - The time series of your choice. In this case, function=TIME_SERIES_MONTHLY
...
def time_series_monthly_adjusted(): 
    ...
    Path('Monthly_Adjusted').mkdir(exist_ok=True)

    filename = f"Monthly_Adjusted/{ticker}_monthly_adjusted.csv"
