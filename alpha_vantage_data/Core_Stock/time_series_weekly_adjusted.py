...
# ==================================================================================================================== # 
# ==================================================================================================================== # 
# Time Series Weekly Adjusted Stock Data # 
...
# ==== API Parameters ==== #
# 1. ❚ Required: function - The time series of your choice. In this case, function=TIME_SERIES_WEEKLY_ADJUSTED
...
def time_series_weekly_adjusted(): 
    ...
    Path('Weekly_Data_Adjusted').mkdir(exist_ok=True)

    filename = f"Weekly_Data_Adjusted/{ticker}_weekly_adjusted.csv"
    with open(filename, 'w') as file:
        file.write(response.text)

    print(f"Successfully Downloaded Weekly Adjusted Data for {ticker} to {filename}")
