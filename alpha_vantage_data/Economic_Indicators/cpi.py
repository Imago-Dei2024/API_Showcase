...
# ==================================================================================================================== # 
# ==================================================================================================================== # 
# Consumer Price Index (CPI) Economic Data # 
...
# ==== API Parameters ==== #
# 1. ❚ Required: function - The function of your choice. In this case, function=CPI

# 2. ❚ Optional: interval - By default, interval=monthly. Strings monthly and semiannual are accepted.
...
def consumer_price_index():
    ...
    # Select Interval
    while True:
        print("Please Select an Interval for Consumer Price Index (CPI) Data:")
        print("1. Monthly")
        print("2. Semiannual")
    ...
    filename = f"Economic_Data/consumer_price_index_{interval}.csv"
    with open(filename, 'w') as file:
        file.write(response.text)

    print(f"Successfully Downloaded Consumer Price Index ({interval}) Data to {filename}")
